...
import init from '../hello_wasm/pkg/hello_wasm_bg.wasm?init';
...
const initAndCallWasm = () => {
  ...
  init({}).then((instance: WebAssembly.Instance) => {
    const exports: any = instance.exports;
    result1Message.value = "Meaning of life: " + exports.get_number(42);
    result2Message.value = "Result: " + exports.lookup(someComplexValues);
  });
};
